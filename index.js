  ...
  if (require.cache.__NR_cache) {
    ...
    try {
      ...
      if (opts) {
        ...
        config = Config.initialize(opts)
      } else {
        // initialize the traditional way (newrelic.js or environment variables)
        config = Config.getOrCreateInstance()
      }
    ...
    require.cache.__NR_cache = new API(agent)
  }

  return require.cache.__NR_cache
}
